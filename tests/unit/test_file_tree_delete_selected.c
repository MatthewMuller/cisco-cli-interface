/**
 * @file test_file_tree_delete_selected.c
 * @brief Unit tests for file_tree_delete_selected function
 *
 * This file contains unit tests for the file_tree_delete_selected function.
 *
...
/**
 * @brief Setup function for file_tree_delete_selected tests
 */
static void setup_file_tree_delete_selected_tests(void) {
  // No specific setup needed for file_tree_delete_selected tests
...
TEST(file_tree_delete_selected_null_connection) {
  ...
  setup_file_tree_delete_selected_tests();
  ...
  result = file_tree_delete_selected(NULL, node, &success_count, &fail_count);
...
TEST(file_tree_delete_selected_null_node) {
  ...
  int success_count = 0, fail_count = 0;
  int result =
      file_tree_delete_selected(&conn, NULL, &success_count, &fail_count);
...
TEST(file_tree_delete_selected_single_selected_file) {
  ...
  int success_count = 0, fail_count = 0;
  result = file_tree_delete_selected(&conn, node, &success_count, &fail_count);
...
TEST(file_tree_delete_selected_multiple_selected_files) {
  ...
  int success_count = 0, fail_count = 0;
  result =
      file_tree_delete_selected(&conn, parent, &success_count, &fail_count);
  ASSERT_EQUAL(0, result); // Should succeed
...
TEST(file_tree_delete_selected_complex_tree_all_selected) {
  ...
  // Call the function under test
  int success_count = 0, fail_count = 0;
  result = file_tree_delete_selected(&conn, root, &success_count, &fail_count);
  ASSERT_EQUAL(0, result); // Should succeed
...
TEST(file_tree_delete_selected_nested_structure) {
  ...
  int success_count = 0, fail_count = 0;
  result =
      file_tree_delete_selected(&conn, level0, &success_count, &fail_count);
  ASSERT_EQUAL(0, result); // Should succeed
